...
namespace Tests\FraudLabsPro\SyliusFraudLabsProPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\FraudLabsPro\SyliusFraudLabsProPlugin\Behat\Page\Shop\WelcomePageInterface;
